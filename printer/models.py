...
class Printer(models.Model):
    ...
    def slice(self,stl_id):
        ...
        response = requests.post('http://wm_slicer_cura:5555/analyse_stl', json={"stl_id": stl_id,'printer_id':self.id})
    ...
    def quote(self,cura_data,stl_data):
        ...
        return  ( (0.91 *(cura_data['print_s'] / 3600)) +9 )
        ...
        if price_total < self.price_min:
            price_total = self.price_min #+ self.price_margin #FIXME: revert back 
