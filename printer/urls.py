...
urlpatterns = [
    path('<int:id>/slicer_check/upload/',views.upload,name='upload_stl'),
    ...
    path('<int:id>/slicer_check/get_available_printers/',views.get_available_printers,name='get_available_printers'),
]