    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_address_line1', models.CharField(blank=True, max_length=255, null=True)),
                ('store_address_line2', models.CharField(blank=True, max_length=255, null=True)),
                ('store_address_city', models.CharField(blank=True, max_length=255, null=True)),
                ('store_address_postal_code', models.CharField(blank=True, max_length=255, null=True)),
                ('store_address_country', models.CharField(blank=True, max_length=255, null=True)),
